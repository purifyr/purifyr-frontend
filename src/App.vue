<template>
  ...
  <div class="min-h-screen p-6 bg-base-100">
    ...
    <!-- URL Reports Tab -->
    <div v-if="activeTab === 'urlReports'" class="mt-6">
      <h3 class="mb-4 text-2xl font-bold">URL Reports Management</h3>
...
// Sample URL reports data (all in 'Pending' status)
const reports = ref([
  { id: 1, url: 'https://example.com', cause: 'Phishing', status: 'Pending' },
  { id: 2, url: 'https://fraudsite.com', cause: 'Fraud', status: 'Pending' },
  {
    id: 3,
    url: 'https://malwaresite.com',
    cause: 'Malware',
    status: 'Pending',
  },
  {
    id: 4,
    url: 'https://hatesite.com',
    cause: 'Harassment',
    status: 'Pending',
  },
  { id: 5, url: 'https://scamsite.com', cause: 'Scam', status: 'Pending' },
  {
    id: 6,
    url: 'https://fakeinfo.com',
...
// Active tab state
const activeTab = ref('urlReports')

// Mock functions for URL reports
...
function rejectReport(reportId: number) {
  const report = reports.value.find(r => r.id === reportId)
  if (report) {
